                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="w-full bg-transparent text-white placeholder-white/50
                                       border-0 border-b border-white/40 focus:border-blue-300
                        ...
                        <div class="flex items-center justify-between text-sm mt-2">
                            <label class="inline-flex items-center text-white/80">
                                <input type="checkbox" name="remember"
                                       class="rounded border-white/40 bg-white/10 text-blue-500 focus:ring-blue-400">
