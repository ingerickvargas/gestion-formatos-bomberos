            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6 mb-6">
                <form method="GET" class="grid grid-cols-1 md:grid-cols-6 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="email" value="{{ request('email') }}" class="mt-1 w-full rounded-md border-gray-300" placeholder="admin@bomberos.local">
                    </div>
                    <div class="md:col-span-1">
                        <label class="block text-sm font-medium text-gray-700">IP</label>
                        <input type="text" name="ip" value="{{ request('ip') }}" class="mt-1 w-full rounded-md border-gray-300" placeholder="127.0.0.1">
                    </div>
                    <div class="md:col-span-1">
                        <label class="block text-sm font-medium text-gray-700">Desde</label>
                        <input type="date" name="from" value="{{ request('from') }}" class="mt-1 w-full rounded-md border-gray-300">
                    </div>
                    <div class="md:col-span-1">
                        <label class="block text-sm font-medium text-gray-700">Hasta</label>
                        <input type="date" name="to" value="{{ request('to') }}" class="mt-1 w-full rounded-md border-gray-300">
                    </div>
                    <div class="md:col-span-6 flex items-center gap-3 mt-2">
                        ...
                        <a href="{{ route('admin.access-logs.index') }}" class="px-4 py-2 bg-sky-800 text-white rounded-md hover:bg-gray-300">
                            Limpiar
                        </a>
                    </div>
                </form>
