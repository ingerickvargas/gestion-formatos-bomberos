                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label for="first_name" class="block text-sm font-medium">Nombre <span class="text-red-500">*</span></label>
                                <x-text-input id="first_name" name="first_name" type="text" class="mt-1 block w-full" value="{{ old('first_name') }}" required />
                                <x-input-error class="mt-2" :messages="$errors->get('first_name')" />
                            </div>

                            <div>
                                <label for="last_name" class="block text-sm font-medium">Apellido <span class="text-red-500">*</span></label>
                                <x-text-input id="last_name" name="last_name" type="text" class="mt-1 block w-full" value="{{ old('last_name') }}" required />
                                <x-input-error class="mt-2" :messages="$errors->get('last_name')" />
                            </div>

                            <div>
                                <label for="document" class="block text-sm font-medium">Cédula <span class="text-red-500">*</span></label>
                                <x-text-input id="document" name="document" type="text" class="mt-1 block w-full" value="{{ old('document') }}" required />
                            ...
                            <div class="md:col-span-2">
                                ...
                                <x-text-input id="email" name="email" type="email" autocomplete="off" class="mt-1 block w-full" value="{{ old('email') }}" required />
                            ...
                            <div>
                                <label for="password" class="block text-sm font-medium">Contraseña <span class="text-red-500">*</span></label>
