...
<div class="space-y-4">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('formats.vehicle-exit-reports.pending') }}" class="px-3 py-2 border rounded-md bg-sky-800 text-white">
            Volver
        </a>
    </div>
    ...
    <form method="POST" action="{{ route('formats.vehicle-exit-reports.driver-update', $report) }}" class="space-y-4">
        ...
        <div class="bg-white shadow rounded p-4 space-y-4">
            ...
            <div>
                ...
                <textarea name="route_description" rows="3" required
                          class="w-full rounded-md border-gray-300">{{ old('route_description') }}</textarea>
            ...
            <div>
                ...
                <textarea name="movement_description" rows="3" required
                          class="w-full rounded-md border-gray-300">{{ old('movement_description') }}</textarea>
            ...
            <div>
                ...
                <textarea name="general_observations" rows="3"
                          class="w-full rounded-md border-gray-300">{{ old('general_observations') }}</textarea>
