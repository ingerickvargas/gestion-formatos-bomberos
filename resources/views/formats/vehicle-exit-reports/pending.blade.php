...
<div class="space-y-4">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('formats.vehicle-exit-reports.index') }}" class="px-3 py-2 border rounded-md bg-sky-800 text-white">
            Ver todos
        </a>
    </div>
    @if(session('success'))
                ...
                @forelse($reports as $r)
                    <tr>
                        ...
                        <td class="px-3 py-2 text-right">
                            <a href="{{ route('formats.vehicle-exit-reports.driver-form', $r) }}"
