...
<style>
  ...
  /* 1 formulario por página */
  .page { page-break-after: always; }
  .page:last-child { page-break-after: auto; }

  /* Encabezado global (mes/filtros) */
...
@forelse($forms as $form)
  <div class="page">
    ...
    <div class="box">
      ...
      <table>
        <tr>
          <th>Nombre</th><th>Tipo Doc</th><th>No Doc</th><th>Edad</th><th>Teléfono</th>
        </tr>
        <tr>
        ...
        <tr>
          <th colspan="2">Dirección</th><th colspan="3">Ocupación</th>
        </tr>
        <tr>
    ...
    <div class="box">
      ...
      <table>
        <tr>
          <th>Pulso</th><th>Resp.</th><th>P/A</th><th>SPO2</th><th>Temp.</th><th>RO</th><th>RV</th><th>RM</th><th>Total</th>
        </tr>
        <tr>
          <td>{{ $form->v_pulse ?? '-' }}</td>
    ...
    @php
      ...
      // Si por algún motivo viene como string JSON, intenta decodificar
    ...
    <div class="box">
      ...
      <table>
        ...
        <tr>
          <th>Alergias</th><th>Medicamentos</th><th>Patologías</th><th>Ambiente</th>
        </tr>
        <tr>
    ...
    <div class="box">
      ...
      <table>
        <tr>
          <th>Estado entrega</th><th>Hora entrega</th><th>Pertenencias</th><th>Quién recibe</th><th>Cédula recibe</th>
        </tr>
        <tr>
        ...
        <tr>
          <th colspan="2">Transportado a (ciudad)</th><th colspan="3">Código</th>
        </tr>
        <tr>
    ...
    <div class="box">
      ...
      <table>
        <tr>
          <th>Conductor</th><th>Tripulante 1</th><th>Tripulante 2</th>
        </tr>
        <tr>
    ...
    <div class="box">
      ...
      <table>
        <tr>
          <th>Servicio</th><th>Personal</th><th>Medios</th><th>Recomendaría</th>
        </tr>
        <tr>
