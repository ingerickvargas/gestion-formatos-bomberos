@php
    ...
    $logoBase64_b = null;
    $logoBase64_bc = null;
    if (file_exists($logoPath) || file_exists($logoPath2) || file_exists($logoPath3)) {
		...
		<table class="header-table">
			<tr>
				...
				<td style="width: 62%;">
					...
					<div class="title">ALCALDIA MUNICIPAL Y CUERPO DE BOMBEROS VOLUNTARIOS</div>
					<div class="title">LA TEBAIDA QUINDIO</div>
					<div class="subtitle" style="margin-top:3px;">Nit: 890 000564-1</div>
					<div class="title">INFORME DE SERVICIOS PRESTADOS POR PARTE DEL CUERPO DE BOMBEROS A LA COMUNIDAD</div>
				</td>
