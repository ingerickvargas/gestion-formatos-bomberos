...
<div
  x-data="{
    tipo: '{{ old('tipo_formato', $r->tipo_formato ?? 'ALCALDIA') }}',
  }"
  class="space-y-4"
>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <input type="date" name="service_date"
                       value="{{ old('service_date', optional($r?->service_date)->format('Y-m-d')) }}"
            ...
            <div>
                ...
                <input type="time" name="service_time"
                       value="{{ old('service_time', $r->service_time ?? '') }}"
                       class="w-full rounded-md border-gray-300">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <input name="patient_name" required
                   value="{{ old('patient_name', $r->patient_name ?? '') }}"
                   class="w-full rounded-md border-gray-300">
        ...
        <div>
            ...
            <input name="document" value="{{ old('document', $r->document ?? '') }}"
                   class="w-full rounded-md border-gray-300">
        ...
        <div>
            ...
            <input name="phone" value="{{ old('phone', $r->phone ?? '') }}"
                   class="w-full rounded-md border-gray-300">
        ...
        <div x-show="tipo !== 'BOMBEROS'">
            ...
            <input name="address" value="{{ old('address', $r->address ?? '') }}"
                   class="w-full rounded-md border-gray-300">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input name="service_type"
                       value="{{ old('service_type', $r->service_type ?? '') }}"
                       class="w-full rounded-md border-gray-300"
					   :disabled="tipo !== 'ALCALDIA'"
                       :required="tipo==='ALCALDIA'">
            ...
            <div>
                ...
                <input name="responsible_name"
                       value="{{ old('responsible_name', $r->responsible_name ?? '') }}"
                       class="w-full rounded-md border-gray-300"
					   :disabled="tipo !== 'ALCALDIA'"
                       :required="tipo==='ALCALDIA'">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                ...
                <input name="service_type"
                       value="{{ old('service_type', $r->service_type ?? '') }}"
                       class="w-full rounded-md border-gray-300"
					   :disabled="tipo !== 'ANCIANATO'"
                       :required="tipo==='ANCIANATO'">
                @error('service_type') <div class="text-sm text-red-600 mt-1">{{ $message }}</div> @enderror
            </div>
            ...
            <div>
                ...
                <input name="responsible_document"
                       value="{{ old('responsible_document', $r->responsible_document ?? '') }}"
                       class="w-full rounded-md border-gray-300"
                       :required="tipo==='ANCIANATO'">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input name="service_type"
                       value="{{ old('service_type', $r->service_type ?? '') }}"
                       class="w-full rounded-md border-gray-300"
					   :disabled="tipo !== 'BOMBEROS'"
                       :required="tipo==='BOMBEROS'">
                @error('service_type') <div class="text-sm text-red-600 mt-1">{{ $message }}</div> @enderror
            </div>

            <div>
                <label class="block text-sm font-medium">Quién realiza <span class="text-red-500">*</span></label>
                <input name="extras[quien_realiza]"
                       value="{{ old('extras.quien_realiza', $r->extras['quien_realiza'] ?? '') }}"
                       class="w-full rounded-md border-gray-300"
                       :required="tipo==='BOMBEROS'">
            ...
            <div>
                ...
                <input name="procedure"
                       value="{{ old('procedure', $r->procedure ?? '') }}"
                       class="w-full rounded-md border-gray-300"
                       :required="tipo==='BOMBEROS'">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="date" name="extras[fecha_atencion]"
                           value="{{ old('extras.fecha_atencion', $r->extras['fecha_atencion'] ?? '') }}"
                           class="w-full rounded-md border-gray-300"
                           :required="tipo==='BOMBEROS'">
                ...
                <div>
                    ...
                    <input type="time" name="extras[hora_atencion]"
                           value="{{ old('extras.hora_atencion', $r->extras['hora_atencion'] ?? '') }}"
                           class="w-full rounded-md border-gray-300"
                           :required="tipo==='BOMBEROS'">
